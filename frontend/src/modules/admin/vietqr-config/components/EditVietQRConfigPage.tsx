...
import { VietQRConfigForm } from "./VietQRConfigForm";
import { useVietQRConfigs } from "../hooks/useVietQRConfigs";
import { VietQRConfig } from "../models/vietqr-config";
import { vietQRConfigService } from "../services/vietqr-config.service";

interface EditVietQRConfigPageProps {
  id: string;
}

export default function EditVietQRConfigPage({
  id,
}: EditVietQRConfigPageProps) {
